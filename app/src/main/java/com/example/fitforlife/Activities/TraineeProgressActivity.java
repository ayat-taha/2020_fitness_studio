...
import com.example.fitforlife.Adapters.ProgressAdapter;
...
public class TraineeProgressActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        traineeListView = findViewById(R.id.list_TraineeProgress);
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                TraineeProgressActivity.this.adapter.getFilter().filter(cs);
            }
    ...
    public void onItemSelected(AdapterView<?> arg0, View arg1, int position, long id) {
        ...
        if (position == 0) {
            ...
            if (!currentTrainee.isEmpty()) {
                ...
                adapter = new ProgressAdapter(context, R.layout.card_trainee_progress, currentTrainee);
            ...
            if (isCoach) {
                ...
                adapter = new ProgressAdapter(this, R.layout.card_trainee_progress, currentTrainee);
                traineeListView.setAdapter(adapter);
            }
            if (isManager) {
    ...
    public void OnClickLogOut(View view) {
        ...
        Intent MoreIntent = new Intent(TraineeProgressActivity.this, MainActivity.class);
    ...
    public void OnClickMore(View view) {
        Intent MoreIntent = new Intent(TraineeProgressActivity.this, MoreActivity.class);
        startActivity(MoreIntent);
    }
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.calendar:
                        if (isManager) {
                            Intent calendarIntent = new Intent(TraineeProgressActivity.this, ManagerCalendarAcitvity.class);
                            startActivity(calendarIntent);
                            overridePendingTransition(0, 0);
                            return true;
                        } else {
                            Intent calendarIntent = new Intent(TraineeProgressActivity.this, CalendarActivity.class);
                            startActivity(calendarIntent);
                            overridePendingTransition(0, 0);
                            return true;
                        }
                    case R.id.progress:
                        if (isCoach || isManager) {
                            Intent postIntent = new Intent(TraineeProgressActivity.this, TraineeProgressActivity.class);
                            startActivity(postIntent);
                            overridePendingTransition(0, 0);
                            return true;
                        } else {
                            Intent ProgressIntent = new Intent(TraineeProgressActivity.this, ProgressActivity.class);
                            startActivity(ProgressIntent);
                            overridePendingTransition(0, 0);
                            return true;
                        }
                    case R.id.home:
                        Intent homeIntent = new Intent(TraineeProgressActivity.this, HomeActivity.class);
                    ...
                    case R.id.payments:
                        ...
                        if (isCoach || isManager) {
                            paymentsIntent = new Intent(TraineeProgressActivity.this, TraineePaymentsActivity.class);
                        } else {
                            paymentsIntent = new Intent(TraineeProgressActivity.this, PaymentsActivity.class);
                        }
                    ...
                    case R.id.profile:
                        if (isManager) {
                            Intent groupsIntent = new Intent(TraineeProgressActivity.this, ManagerCoachTraineeGroupsActivity.class);
                            startActivity(groupsIntent);
                            overridePendingTransition(0, 0);
                            return true;
                        }
                        if (isCoach) {
                            Intent groupsIntent = new Intent(TraineeProgressActivity.this, GroupsTraineeActivity.class);
                            startActivity(groupsIntent);
                            overridePendingTransition(0, 0);
                            return true;
                        } else {
                            Intent profileIntent = new Intent(TraineeProgressActivity.this, ProfileActivity.class);
