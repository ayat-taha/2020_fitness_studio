...
import com.example.fitforlife.Adapters.CommentAdapter;
import com.example.fitforlife.Model.Comment;
...
public class CommentsActivity extends AppCompatActivity {
    ...
    public void OnClickMore(View view) {
        Intent MoreIntent = new Intent(CommentsActivity.this, MoreActivity.class);
    ...
    public void OnClickLogOut(View view) {
        ...
        Intent MoreIntent = new Intent(CommentsActivity.this, MainActivity.class);
        startActivity(MoreIntent);
        finish();
