...
public class TraineePopUpAdapter extends ArrayAdapter<UserInfo> {
    ...
    public TraineePopUpAdapter(Context context, int resource, List<UserInfo> data, Fragment fragment) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View rootView = inflater.inflate(R.layout.card_trainee_popup, null, false);
        ...
        editIcon.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ((Groups_Fragment) fragment).closeDialog();
