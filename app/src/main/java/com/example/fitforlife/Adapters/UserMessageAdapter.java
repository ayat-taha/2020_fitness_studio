...
import com.example.fitforlife.Activities.ChatActivity;
...
public class UserMessageAdapter extends RecyclerView.Adapter<UserMessageAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        switch (user.getType()) {
            case "Trainee":
                holder.type.setText(mContext.getResources().getString(R.string.trainee));
                break;
            case "coach":
                holder.type.setText(mContext.getResources().getString(R.string.coach));
                break;
            case "manager":
                holder.type.setText(mContext.getResources().getString(R.string.manager));
                break;
            default:
                holder.type.setText(" ");
                break;
